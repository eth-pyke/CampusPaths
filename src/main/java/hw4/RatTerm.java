...
public final class RatTerm {
   ...
   * @spec.effects Constructs a new RatTerm t, with t.coeff = c, and if
   ...
   * @spec.requires 'termStr' is an instance of a string with no spaces that
